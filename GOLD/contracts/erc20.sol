...
contract GOLD {
  ...
  uint256 public total_supply = '42000000';

  bytes32 public _name = 'OPEN AURUM';
  uint8 public _decimals = 8;
  bytes32 public _symbols = 'GOLD';
  ...
  function GOLD(uint256 _initial_Amount, bytes32 name, uint8 decimals, bytes32 symbol) {
