...
contract GLDS {
  ...
  uint256 public total_supply = '2000000000';

  bytes32 public _name = 'STABLE GOLD';
  uint8 public _decimals = 8;
  bytes32 public _symbols = 'GLDS';
  ...
  uint256 public buy_Price = 1;
  uint256 public sell_Price = 1;

  event Transfer(address indexed _from, address indexed _to, uint256 _value);
  event Approval(address indexed _owner, address indexed _spender, uint256 _value);

  function GLDS(uint256 _initial_Amount, bytes32 name, uint8 decimals, bytes32 symbol) {
